...
<body>
    <h2>My Charts</h2>
    <ul>
        <li><a href="dailyChart.jsp"><i class="fas fa-calendar-day"></i> View Daily Chart</a></li>
        <li><a href="weeklyChart.jsp"><i class="fas fa-calendar-week"></i> View Weekly Chart</a></li>
        <li><a href="monthlyChart.jsp"><i class="fas fa-calendar-month"></i> View Monthly Chart</a></li>
    </ul>
